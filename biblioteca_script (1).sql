...
CREATE TABLE IF NOT EXISTS `biblioteca`.`Livro` (
  ...
  `Emprestimo_idEmp` INT NOT NULL,
  PRIMARY KEY (`idLivro`),
  INDEX `fk_Livro_Emprestimo1_idx` (`Emprestimo_idEmp` ASC) ,
  CONSTRAINT `fk_Livro_Emprestimo1`
    FOREIGN KEY (`Emprestimo_idEmp`)
    REFERENCES `biblioteca`.`Emprestimo` (`idEmp`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`Autor` (
  ...
  PRIMARY KEY (`idAutor`),
  INDEX `fk_Autor_Editora1_idx` (`Editora_cnpj` ASC) ,
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`Bibliotecario` (
  ...
  INDEX `fk_Bibliotecario_Emprestimo1_idx` (`Emprestimo_idEmp` ASC) ,
